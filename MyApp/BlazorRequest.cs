...
namespace MyApp
{
    ...
    public class BlazorFakeHttpContext : HttpContext
    {
    ...
    public class BlazorFakeHttpRequest : HttpRequest
    {
    ...
    public class BlazorResponse : IResponse
    {
    ...
    public class BlazorRequest : IRequest
    {
